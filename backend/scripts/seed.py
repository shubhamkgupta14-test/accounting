...
ALLOWED_GROUPS = {
    "Asset": {"Cash", "Bank", "Current Assets", "Deffered Tax Assets", "Fixed Assets", "Non-current Assets"},
    "Liability": {"Current Liabilities", "Tax Liabilities", "Deffered Tax Liabilities", "Long-term Liabilities"},
    "Equity": {"Capital"},
...
DEFAULT_ACCOUNTS = [
    ...
    {"code": "CA003", "name": "Stock-in-Hand",
        "type": "Asset", "group": "Current Assets"},
    {"code": "GSTIN001", "name": "Input IGST",
        "type": "Asset", "group": "Deffered Tax Assets"},
    {"code": "GSTIN002", "name": "Input CGST",
        "type": "Asset", "group": "Deffered Tax Assets"},
    {"code": "GSTIN003", "name": "Input SGST",
        "type": "Asset", "group": "Deffered Tax Assets"},
    ...
    {"code": "TX002", "name": "TDS Payable",
        "type": "Liability", "group": "Tax Liabilities"},
    {"code": "GSTOUT001", "name": "Output IGST",
        "type": "Liability", "group": "Deffered Tax Liabilities"},
    {"code": "GSTOUT002", "name": "Output CGST",
        "type": "Liability", "group": "Deffered Tax Liabilities"},
    {"code": "GSTOUT003", "name": "Output SGST",
        "type": "Liability", "group": "Deffered Tax Liabilities"},
